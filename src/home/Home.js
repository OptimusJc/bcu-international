    ...
    return (
        <div className="home" style={{ marginBottom: "3rem" }}>
            ...
            <ul className="video_list">
                <li>
                    <span>001</span>
                    <ReactPlayer className="video_image" url="https://www.youtube.com/watch?v=be6i4m2GeBE" />
                    <span className="live">live</span>
                    <p>First Video Title</p>
                </li>
                <li>
                    <span>002</span>
                    <ReactPlayer className="video_image" url="https://www.youtube.com/watch?v=jX5EEgA6upQ" />
                    <span className="live">live</span>
